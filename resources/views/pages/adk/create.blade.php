    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Form Tambah Data Anak dengan kedisabilitasan (ADK) (umur 18 tahun)</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Form Tambah Data Anak dengan kedisabilitasan (ADK) (umur 18 tahun)</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title text-white">Tambah Data Anak dengan kedisabilitasan (ADK) (umur 18 tahun)</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('adk.store') }}" method="POST">
                  @csrf
