    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Form Tambah Warga Pindah Dalam Wilayah</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Form Tambah Warga Pindah Dalam Wilayah</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title text-white">Tambah Data Warga Dalam Wilayah</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('pindah_wilayah.store') }}" method="POST">
                  @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="alamat_asal" value="{{ old('alamat_asal') }}" style="width: 100%;">
                        ...
                        @foreach ($warga as $item )
                          <option value="{{ $item->alamat_domisili }}">{{ $item->alamat_domisili }}</option>
                        @endforeach
                        </select>
                    </div>
