            ...
            <div class="col-md-8">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title text-white">Tambah Data Wahana Kesejahteraan Sosial Keluarga Berbasis Masyarakat (WKSBM)</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('wksbm.store') }}" method="POST">
                  @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" value="{{ old('nama') }}" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="masukkan nama tksk" >
                      @error('nama')
