    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Form Tambah Data Dunia Usaha</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Form Tambah Data Dunia Usaha</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title text-white">Tambah Data Dunia Usaha</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('dunia-usaha.store') }}" method="POST">
                  @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_usaha" value="{{ old('nama_usaha') }}" class="form-control @error('nama_usaha') is-invalid @enderror" id="nama_usaha" placeholder="masukkan nama usaha" >
                      @error('nama_usaha')
