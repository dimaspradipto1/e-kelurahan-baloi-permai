            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                      ...
                      <form  action="{{ route('import-sekolah') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Import Excel Sekolah</h5>
                          </div>
                  ...
                  <a href="{{ route('sekolah.create') }}" class="btn btn-secondary mb-2">Tambah</a>

                  <a href="{{ route('export-sekolah') }}" class="btn btn-success mb-2" target="_blank">EXPORT EXCEL</a>
