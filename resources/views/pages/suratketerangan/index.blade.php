          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Data Surat Keterangan</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                  ...
                  <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <form  action="{{ route('import-surat-keterangan') }}" method="POST" enctype="multipart/form-data">
                  ...
                  {{-- end import excel --}}
                  <a href="{{ route('surat-keterangan.create') }}" class="btn btn-secondary mb-2"> + Tambah</a>

                  <a href="{{ route('export-surat-keterangan') }}" class="btn btn-outline-success mb-2" target="_blank"><i class="fa-regular fa-file-excel"></i> EXPORT EXCEL</a>
