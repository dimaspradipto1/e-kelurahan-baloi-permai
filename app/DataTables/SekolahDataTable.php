...
class SekolahDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($sekolah){
                return '
                <a href="'.route('sekolah.edit', $sekolah->id).'" class="btn btn-sm btn-warning text-white px-3"><i class="fa-solid fa-pen-to-square"></i>  Edit</a>
     ...
     */
    public function query(Sekolah $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nama')->title('Nama Sekolah'),
